...
public class MainController implements Initializable {
    ...
    private static final List<String> cats =
            Arrays.asList("bombersClient/src/main/resources/img/cat/fat1.png", "bombersClient/src/main/resources/img/cat/fat2.png"
                    , "bombersClient/src/main/resources/img/cat/fat3.png", "bombersClient/src/main/resources/img/cat/fat4.png");

    private static final List<String> maps =
            Arrays.asList("bombersClient/src/main/resources/img/maps/map1.png", "bombersClient/src/main/resources/img/maps/map2.png"
                    , "bombersClient/src/main/resources/img/maps/map3.png", "bombersClient/src/main/resources/img/maps/map4.png");

    private static final Map<String, String> mapsHashMap = new HashMap<String, String>() {{
        put("bombersClient/src/main/resources/img/maps/map1.png", "CASTLE");
        put("bombersClient/src/main/resources/img/maps/map2.png", "SAND");
        put("bombersClient/src/main/resources/img/maps/map3.png", "NEON");
        put("bombersClient/src/main/resources/img/maps/map4.png", "JUNGLE");
    }};
    ...
    public void pressStartButton(ActionEvent event) throws Exception {
        bg.setImage(new Image(new FileInputStream("bombersClient/src/main/resources/img/bg2.png")));
    ...
    public void pressFirstReadyButton(ActionEvent event) throws Exception {
        bg.setImage(new Image(new FileInputStream("bombersClient/src/main/resources/img/bg3.png")));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        info.setVisible(false);
        try {
            cur_image = "bombersClient/src/main/resources/img/cat/fat1.png";
            cur_map = "bombersClient/src/main/resources/img/maps/map1.png";


            bg.setImage(new Image(new FileInputStream("bombersClient/src/main/resources/img/bg1.png")));
            cat.setImage(new Image(new FileInputStream(cur_image)));
            map.setImage(new Image(new FileInputStream(cur_map)));
